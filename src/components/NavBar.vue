<template>
    <div>
        <v-app-bar app dark>
            <v-icon large>mdi-rodent</v-icon>
            <v-app-bar-title class="text-no-wrap" shrink-on-scroll>
                Squeak Escapes
            </v-app-bar-title>
            ...
            <v-toolbar-items class="hidden-md-and-up">
                <v-btn elevation="0" @click.prevent="toggleDrawer">
